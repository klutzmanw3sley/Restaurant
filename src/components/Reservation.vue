...
// make reservation - add reservation details to local store
...
<template>
                ...
                <v-card max-width="800" class="pa-6 rounded-lg" justify="center">
                   ...
                   <v-row>
                    ...
                    <v-row>
                        ...
                        <v-col md="8">
                            <v-text-field tpye="number" v-model="noOfPeople"></v-text-field>
                        </v-col>
                    </v-row>
                    <v-row>
    ...
    <v-menu v-model="showMenu" :close-on-content-click="false" activator="parent" min-width="0" >
        <v-time-picker v-model="reservationTime"></v-time-picker>
                    ...
                    <v-row>
                        <v-col align="center">
                            <v-btn color="indigo-darken-4"  @click="makeReservation()">Make Reservation</v-btn>
                        </v-col>
                    </v-row>
                </v-card>
            </v-col>
